...
struct qt_meta_stringdata_CLASSsplashENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSsplashENDCLASS = QtMocHelpers::stringData(
    "splash",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSsplashENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject splash::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSsplashENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSsplashENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSsplashENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *splash::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSsplashENDCLASS.stringdata0))
